...
offset = 275
print((avg_udr_big_rewards - avg_cubic_rewards)/avg_cubic_rewards)
print((real_avg_udr_big_rewards - real_avg_cubic_rewards)/real_avg_cubic_rewards)
ax.bar([3, 5.5], np.array([avg_udr_big_rewards, real_avg_udr_big_rewards]) + offset, width,
       yerr=[avg_udr_big_rewards_errs, real_avg_udr_big_rewards_errs],
              color="C4", alpha=1, label='RL-based policy', bottom=-offset)
ax.bar([4, 6.5], np.array([avg_cubic_rewards, real_avg_cubic_rewards])+ offset, width,
       yerr=[avg_cubic_rewards_errs, real_avg_cubic_rewards_errs],
        color="C0", alpha=1, label='Rule-based policy (TCP Cubic)', bottom=-offset)
ax.set_xticks([3.5, 6])
ax.set_xticklabels(["Simulation", 'Real testbed'])
ax.set_ylabel('Test reward')
ax.set_ylim(-offset, 600)
ax.legend()
